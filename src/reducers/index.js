...
import { cities, getForecastDataFromCities as _getForecastDataFromCities, getWheatherCities as _getWheatherCities, getBanner as _getBanner } from './cities';
...
// Creamos el selector para filtrar el dato del banner
export const getBanner = createSelector(state => state.cities, getCity, _getBanner);
